...
| Диаграмма | Описание |
|-----------|----------|
| [Контекстная диаграмма](https://github.com/Ekaterina855/fitcommunity-architecture/blob/main/diagrams/Контекстная диаграмма (C4 Context Level).svg) | Контекстная (C4) – взаимодействие системы с внешним миром |
